...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/wangEditor.min.css" />
...
<body>
    ...
    <div id="blog-header" class="container">
        <h2>
            撰写博客<small class="change-to"><a id="convert-button" href="javascript:void(0);">切换至Markdown编辑器</a></small>
        </h2>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/beautify-html.min.js"></script>
    <%@ include file="/pages/common/default_js.jsp"%>
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/new-w.js"></script>
</body>
</html>