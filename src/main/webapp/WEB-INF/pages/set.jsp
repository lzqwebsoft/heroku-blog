...
<div id="container">
	<div id="back_intro">
        ...
        <div id="configure_info" style="display:none;">
           <p>博客名称<br /><input type="text" name="blog_name" maxlength="30" style="width:460px"/></p>
           <p>个性签名<br /><input type="text" name="signature" maxlength="30" style="width:460px" /></p>
           <p>关联邮箱<br /><input type="text" name="blog_email" maxlength="30" style="width:460px" /></p>
           <p>
              博客描述<br />
