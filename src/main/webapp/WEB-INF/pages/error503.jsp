...
<body>
    ...
    <div id="container">
        <div id="content-div" style="margin: 50px 40px 10px 40px;">
            <h2><spring:message code="info.error503.title" /></h2>
            <p style="border-bottom: 1px solid #000000; margin-top: 10px;"></p>
       
            <div style="margin: 20px 0px; padding-left: 10px; height: 100px;">
               <p style="display: inline-block; width: 100px; height: 100px;
                  background-image: url('<%= request.getContextPath() %>/resources/images/error503.jpg');"></p>
